import type { ScrapterDOMState } from './dom/views';
 ...
 * This is now unified with ScrapterDOMState.
 */
export type PageState = ScrapterDOMState;
...
/**
 * Represents the full browser state, including all tabs.
 */
