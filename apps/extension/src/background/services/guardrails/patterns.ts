...
export const SECURITY_PATTERNS: SecurityPattern[] = [
  ...
  {
    pattern: /\bscrapter[-_ ]+untrusted[-_ ]+content\b/gi,
    type: ThreatType.PROMPT_INJECTION,
    description: 'Attempt to fake untrusted content tags',
    replacement: '',
  },
  {
    pattern: /\bscrapter[-_ ]+user[-_ ]+request\b/gi,
    type: ThreatType.PROMPT_INJECTION,
  ...
  {
    pattern: /\bscrapter[-_]+attached[-_]+files\b/gi,
    type: ThreatType.PROMPT_INJECTION,
...
export const PRESERVED_TAGS = [
  'scrapter_untrusted_content',
  'scrapter_user_request',
  'scrapter_attached_files',
  'scrapter_file_content',
];
