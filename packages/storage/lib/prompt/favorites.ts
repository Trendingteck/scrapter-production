...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Follow us at https://x.com/scrapter_ai to stay updated on the latest news and features!',
  },
  {
    title: 'ðŸŒŸ Star us on GitHub!',
    content:
      "Open the scrapter repository at https://github.com/scrapter/scrapter and check if you've already starred it. If not, please support us by giving us a star!",
  },
];
